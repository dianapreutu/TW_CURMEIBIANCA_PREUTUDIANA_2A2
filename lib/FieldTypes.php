...
// lib/FieldTypes.php
// Defineste tipurile de campuri suportate de generator
// Fiecare tip stie sa genereze o valoare aleatorie realista

class FieldTypes
{
    // Genereaza o valoare pentru tipul de camp specificat
    ...
    // Returneaza lista tuturor tipurilor disponibile cu labelurile lor
    ...
    // Returneaza descrierea unui tip de camp pentru tooltip in UI
    ...
    // Prenume romanesti masculine si feminine
    ...
    // Adresa de email generata din prenume si nume
    ...
    // Numar de telefon cu prefix real de retea din Romania
    ...
    // Adresa completa cu strada, numar si oras
    ...
    // CNP cu format valid si cifra de control calculata corect
    ...
    // Calculeaza cifra de control a CNP-ului conform algoritmului oficial
    ...
    {
        return 'RO' . rand(10000000, 99999999);
    }

    // IBAN romanesc cu prefix banca real
    ...
    // Cotele de TVA valabile in Romania
    ...
    private static function company(): string
    {
        ...
        return $names[array_rand($names)] . ' ' . $prefixes[array_rand($prefixes)];
    }
    ...
    // Data aleatorie in interval configurabil, format romanesc ZZ.LL.AAAA
    private static function date(array $options = []): string
    {
        ...
        return date('d.m.Y', rand($start, $end));
    }
    ...
    // Elimina diacriticele dintr-un string, folosit la generarea email-urilor
