...
// api/documents.php
// API pentru gestionarea documentelor generate
// Primeste cereri AJAX si returneaza raspunsuri JSON
// Operatii disponibile: generare, listare, obtinere, stergere
...
// Returneaza lista documentelor apartinand utilizatorului curent
...
// Returneaza un document specific dupa ID
...
// Genereaza un document pe baza unui sablon si a datelor primite sau generate aleatoriu
function handleGenerate(AuthService $authService, DocumentService $documentService, DataService $dataService)
{
    ...
    try {
        if ($dataSource === 'csv') {
            ...
            // Daca nu s-au extras campuri din sablon, folosim setul implicit
            if (empty($fields)) {
                $fields = [
